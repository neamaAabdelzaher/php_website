        ...
        <div class="top_nav">
            <div class="nav_menu">
                ...
                <ul class=" navbar-right">
                  ...
                  <img src="./img/<?= $result['user_image'] ?>" alt="">
                      <?php
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-sm-12">
                            ...
                            <div <?php  if (isset($_GET['msg'])){?> class="alert alert-danger w-50 text-center" role="alert">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        <tr>
                          <td hidden><?=$cat['cat_id']?></td>
                          <td ><?=$cat['cat_name']?></td>
                          <td><a href="editCategory.php?cat_id=<?=$cat['cat_id']?>"> <img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href="delete.php?cat_id=<?=$cat['cat_id']?>"> <img src="./images/delete.png" alt="Delete"></a></td>
