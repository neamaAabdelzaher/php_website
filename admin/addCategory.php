...
if (isset($_POST['add_cat'])) {
	$sql = "INSERT  INTO category (cat_name,username) VALUES (?,?)";
	$stmt = $conn->prepare($sql);
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								<a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
									...
									<img src="./img/<?= $result['user_image'] ?>" alt=""><?php echo $_SESSION['username']; ?>
								</a>
									...
									<form method="post" action="" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="cat_name" id="add-category" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="add-category">user name: <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="username" value="<?php echo $_SESSION['username']; ?>" id="add-category" required="required" class="form-control ">
