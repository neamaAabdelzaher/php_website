						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									?>
									<form method="post" action="update.php" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										<div hidden class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="photo-Id">Product Id <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="prd_id" value="<?= $result['prd_id'] ?>" id="photo-Id" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" name="prd_date" value="<?= $result['prd_date'] ?>" id="photo-date" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="prd_title" value="<?= $result['title'] ?>" id="title" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="license" value="<?= $result['prd_license'] ?>" required="required" class="form-control">License</textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="dimension" class="col-form-label col-md-3 col-sm-3 label-align">Dimension <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="dimension" class="form-control" value="<?= $result['prd_dimension'] ?>" type="text" name="dimension" required="required">
											</div>
										</div>
										<div class="item form-group">
											<label for="format" class="col-form-label col-md-3 col-sm-3 label-align">Format <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="format" class="form-control" value="<?= $result['image_formate'] ?>" type="text" name="format" required="required">
											</div>
										</div>
										<br>
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												...
												<label>
													...
													<input type="checkbox" class="flat" id="is_active"  name="is_active" <?php if($result['is_active']=="Yes"){ echo "checked";} else{echo " ";} ?>>
										...
										<!-- product image -->
										<div class="text-center">
											<img src="./img/<?= $result['prd_image'] ?>" width="250px" height="250px" class=" img-thumbnail rounded m-2" alt="product image">
										</div>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align " for="title">Category Id:<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											<textarea id="content" name="cat_value" readonly required="required" class="form-control"><?= $result['cat_id'] ?></textarea>
											</div>
										</div>
										...
										<!-- Admin Name can not be updated -->
										<div class="item form-group">
											<label for="dimension" class="col-form-label col-md-3 col-sm-3 label-align">Admin Name <span class="required"></span></label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" readonly value="<?= $result['username'] ?>" name="admin_name" id="dimension" class="form-control " name="dimension" required="required">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" name="update_prd" class="btn btn-success">Update</button>
											</div>
										</div>
