            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  ...
                  <img src="./img/<?= $result['user_image'] ?>" alt=""><?php
                          ...
                          <tbody>
                            ...
                            ?>
                                <tr>
                                  ...
                                  <td><?= $row['email'] ?></td>
                                  <td><?= $row['is_admin'] ?></td>
                                  <td><a href="editUser.php?username=<?= $row['username']; ?>"><img src="./images/edit.png" alt="Edit"></a></td>
                                  <td><a href="delete.php?username=<?= $row['username']; ?>"><img src="./images/delete.png" alt="Delete"></a></td>
