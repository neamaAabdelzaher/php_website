...
if (isset($_POST['add'])) {
	...
	$sql = "INSERT INTO users (full_name,username,email,is_admin,password) VALUES (?,?,?,?,?)";
	$stmt = $conn->prepare($sql);
	...
	$res = $stmt->execute([$fullName, $uName, $email, $is_admin, $password]);
									...
									<form action="" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="full_name" id="name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
