                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        ...
                        <tr>
                          <td><?=$prd['prd_date']?></td>
                          <td><?=$prd['title']?></td>
                          <td><img src="./img/<?= $prd['prd_image']  ?>" width="100px" height="50px"></td>
                          <td><?=$prd['is_active']?></td>
                          <td><a href="editPhoto.php?prd_id=<?=$prd['prd_id']?>"><img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href="delete.php?prd_id=<?=$prd['prd_id']?>"><img src="./images/delete.png" alt="Delete"></a></td>
