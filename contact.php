        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown open " <?php if (isset($_SESSION['username'])) { ?>>
                     ...
                     $image=$stmt->fetch();
                     ?>
                    <img src="./admin/img/<?=$image['user_image']?>" width="100px" height="50px" class="rounded-circle w-50" alt=""> 
    ...
    <div class="container-fluid tm-mt-60">
        ...
        <div class="row tm-mb-74 tm-people-row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="./admin/img/people-1.jpg" alt="Image" class="mb-4 img-fluid">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="./admin/img/people-2.jpg" alt="Image" class="mb-4 img-fluid">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="./admin/img/people-3.jpg" alt="Image" class="mb-4 img-fluid">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="./admin/img/people-4.jpg" alt="Image" class="mb-4 img-fluid">
